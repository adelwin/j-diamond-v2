...
public class BaseActionException extends BaseException {
	 ...
	 * 
	 */
	public BaseActionException(String msg) {
		super(msg);
	}
	 ...
	 * 
	 */
	public BaseActionException(Throwable rootCause) {
	...
	public BaseActionException(String msg, Throwable rootCause) {
	 ...
	 * 
	 */
	public BaseActionException(String msg, String msgKey) {
	 ...
	 * 
	 */
	public BaseActionException(String msg, String errorCode, Throwable rootCause) {
		super(msg);
		this.rootCause = rootCause;
